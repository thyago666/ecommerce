    ...
    <div class="row">
      ...
      <div class="col-lg-9">
        ...
        <div class="row">
                ...
                @foreach($psqProdutos as $psqProduto)
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="{{asset("images/products/$psqProduto->imagem.$psqProduto->extensao")}}" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="{{url("/detalhes/$psqProduto->id")}}">{{$psqProduto->nome}}</a>
                </h4>
                <h5>{{$psqProduto->valor}}</h5>
                <p class="card-text">{{$psqProduto->descricao}}</p>
              </div>
